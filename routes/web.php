...
// Room routes
    ...
    Route::prefix('booking-sources')->name('sources.')->group(function () {
        Route::get('/',            \App\Livewire\BookingSource\Index::class)->name('index');
        Route::get('/create',      \App\Livewire\BookingSource\Create::class)->name('create');
